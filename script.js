...
const translations = {
    ...
    en: {
        ...
        loveText: "Honest stories of two people — walks, dates and special moments.",
    ...
    cz: {
        ...
        loveText: "Upřímné příběhy dvou lidí — procházky, schůzky a výjimečné okamžiky.",

        weddingTitle: "Svatba",
        weddingText: "Celý svatební den nebo jeho jednotlivé části — od detailů po skutečné emoce.",
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    console.log("Nelli Photography: script запущено");
