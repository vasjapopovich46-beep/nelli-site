...
const translations = {
    ...
    ru: {
        ...
        loveText:
            "Искренние истории двух людей — прогулки, свидания и особенные моменты.",

        weddingTitle: "Свадьба",
        weddingText:
            "Полный день или отдельные части свадьбы — от деталей до настоящих эмоций.",
    ...
    en: {
        ...
        loveText:
            "Honest stories of two people — walks, dates and special moments.",
    ...
    cz: {
        ...
        loveText:
            "Upřímné příběhy dvou lidí — procházky, schůzky a výjimečné okamžiky.",
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    console.log("Nelli Photography script.js запущено");
    ...
    if (form) {
        ...
        console.log("Форма bookingForm знайдена");
            ...
            async function (event) {
                ...
                try {
                    ...
                    /*
                       ...
                       Відповідь браузер прочитати не може,
                       але POST буде відправлений.
                    */
